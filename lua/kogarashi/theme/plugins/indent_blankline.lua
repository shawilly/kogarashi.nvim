...
function M.get(c, config, _)
  -- accent | default
  local isContextAccent = config.plugins.indent_blankline.context_highlight == "accent"
  ...
  return {
    ...
    IndentBlanklineContextChar = isContextAccent and { fg = c.base.orange } or {
      fg = c.editorIndentGuide.activeBackground,
    },
    IndentBlanklineContextStart = {
      sp = isContextAccent and c.base.orange or c.editorIndentGuide.activeBackground,
